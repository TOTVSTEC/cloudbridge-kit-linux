...
function copyDependencies() {
	...
	var appserverbin = path.join(projectDir, 'build', 'linux', 'bin', 'appserver', 'appserver');

	shelljs.chmod('+x', path.join(target, 'linux', 'bin', 'appserver', 'appserver'));
	//shelljs.chmod('+x', path.join(target, 'linux', 'bin', 'smartclient', 'smartclient'));
}

function applyTemplate() {
	var ini = path.join(projectDir, 'build', 'linux', 'bin', 'smartclient', 'smartclient.ini'),
